...
def YouTube_music(genre):

    keyword = genre + ' genre song'
    ...
    while total_hour < 24:
        ...
        total_duration = total_hour * 60 * 60 + total_minute * 60
        total_duration = total_duration + 59
    ...
    durationResult = 'Played for {h} hours {m} minutes 59 seconds\n'
    print(durationResult.format(h=total_hour, m=total_minute), end='')


def main(inputGenre):
    # print("YouTubeMusic crawling >>>>>>>>>>>>>>>>>>>>")
    YouTube_music(inputGenre)
